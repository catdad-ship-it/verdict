...
export default function SignupPage() {
  ...
  if (done) return (
    <div className="w-full max-w-sm text-center">
      <div className="px-4 py-2 inline-flex items-center mb-8" style={{ background: 'var(--amber)' }}>
  ...
  return (
    <div className="w-full max-w-sm">
      <div className="flex justify-center mb-10">
        <div className="px-4 py-2" style={{ background: 'var(--amber)' }}>
      ...
      <div className="rounded-sm p-8" style={{ background: 'var(--surface)', border: '1px solid var(--border)', boxShadow: '0 24px 60px rgba(0,0,0,0.6)' }}>
        ...
        <form onSubmit={handleSignup} className="space-y-4">
          ...
          <button type="submit" disabled={loading} className="vcr-btn-primary w-full py-3 text-sm mt-2">
